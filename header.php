...
<header>
  <nav class="navbar navbar-expand-lg navbar-light bg-danger text-light py-3 main-nav">
    <div class="container">
      <a class="navbar-brand" href="/TermProject/index.php"><img src="/TermProject/projectImage/header/NEITTER2.png"
...
<div class="headcontainer">
  <div class="home">
    <a href="/TermProject/index.php"><img id="homeImg" src="/TermProject/projectImage/header/home.png" alt="homeLogo"
  ...
  <div class="userInfo">
    <a href="/TermProject/member/member_login_form.php"><i class="fa fa-check">로그인</i></a>
    <!--member_login_form 이동-->
    <a href="/TermProject/member/member_join_form.php"><i class="fa fa-address-card">회원가입</i></a>
    <!--member_join_form 이동-->
