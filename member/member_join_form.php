            ...
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <form action="member_join.php" method="post">
                        ...
                        <input type="text" id="uid" name="id" class="form-control" autocomplete=off placeholder="ID"
                            required autofocus>
                        ...
                        <input type="text" name="nickname" class="form-control" autocomplete=off placeholder="Nickname"
                            required>
                        <br>
