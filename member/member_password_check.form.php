    ...
    <body>     
        ...
        <div class="row">
            ...
            <label for="inputPassword">현재 비밀번호</label>
                <input type="password" id="inputPassword" name="pw" class="form-control" autocomplete=off required>
                <label for="inputPassword">새 비밀번호</label>
                <input type="password" id="inputPassword" name="new_pw" class="form-control" autocomplete=off  required>
                <small style="color:red">8~15자,영문,숫자,특수문자가 들어가야 합니다.</small>
                <br>
                <br>
                <label for="inputPassword">새 비밀번호 확인</label>
                <input type="password" id="inputPassword" name="new_pw_check" class="form-control" autocomplete=off  required>
