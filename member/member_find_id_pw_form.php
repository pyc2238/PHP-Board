                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        <form action="member_find_id_pw.php" method="post">
                            ...
                            <input type="text" id="uid" name="id" name="id" class="form-control" autocomplete=off
                                required>
                            <br>
                            <br>
                    ...
                    <div class="col-sm">
                        <div id="checkIdbox">
                            <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                ...
                                <label class="custom-control-label" for="customControlInline"><b style="color:blue;">아이디
                                        분실</b></label>
                            </div>
                        </div>
                        <!--end of checkIdbox-->
